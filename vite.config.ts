      ...
      build: {
          externalGlobals: [
              [
                  "vue",
                  cdn
                      .cdnjs('Vue',"vue.global.prod.min.js")
                  .concat('https://cdnjs.cloudflare.com/ajax/libs/vue-demi/0.14.6/index.iife.min.js')
                  .concat(
